...
type Tenant struct {
	...
	Type     TenantType   `json:"type"     gorm:"not null"`
...
func (t *Tenant) IsOrg() bool { return t.Type == TenantTypeOrganization }

// IsBranch returns true if this tenant is a branch.
func (t *Tenant) IsBranch() bool { return t.Type == TenantTypeBranch }

// IsPlatform returns true if this tenant is the platform root.
func (t *Tenant) IsPlatform() bool { return t.Type == TenantTypePlatform }
